...
(defparameter *end-ore-oney*
  ...
  "The smaller end-ore-oney problem. The constraints could be optimized
a bit, i. e. the equations can be simplified. Of course, that does not reduce
the search space to prune.")
