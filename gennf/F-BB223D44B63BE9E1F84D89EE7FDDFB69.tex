...
Currently most version management systems doesn't use any digital signatures
...
\item integration in \textsc{metacvs} commands like commit, checkout, blame.
\item implement more \textsc{metacvs} commands like verify, sign
\end{itemize}
...
which need to be wrapped in a C-Interface for \textsc{clisp}.
...
Probably an emacs-integration for metacvs, including the audit-part
would be useful.
